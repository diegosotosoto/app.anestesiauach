          ...
          <section class="app-hero app-hero-blue">
            <div class="app-hero-row">
              <div class="app-hero-body">
                <div class="app-hero-kicker">APP clínica • directorio hospitalario</div>
                <h2>Teléfonos frecuentes</h2>
                <p>Directorio clínico ordenado para encontrar rápido una unidad y llamar desde el móvil.</p>
              </div>
            </div>
          </section>
