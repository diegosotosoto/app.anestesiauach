...
<!-  NAVBAR  ->	
	...
	<?php
		...
		$titulo_navbar=" ";
		$boton_navbar="<form method='post' action='generar_pdf.php' target='_blank');'><input type='hidden' name='fecha_v' value='$fecha_v'><button class='btn btn-lg shadow-sm' type='submit' name='rut_v' value='$rut_v'><div class='text-white'><i class='fa-solid fa-file-pdf'></i></div></button></form>";
