...
<!-  NAVBAR  ->	
	...
	<?php
		...
		$boton_toggler="<form method='post' action='listar_visitas.php'><button class='btn d-sm-block d-sm-none btn-lg shadow-sm border-light' style='; --bs-border-opacity: .1;' type='submit' name='lista_v' value='$rut_v'><div class='text-white'><i class='fa fa-chevron-left'></i>Atrás</div></button></form>";
		$titulo_navbar=" ";
...
<ul class="list-group">
	...
	<?php
		...
		echo "<li class='list-group-item mb-2 py-3' style='background-color: #e9effb; background-image: linear-gradient(0deg, #e9effb 0%, #ffffff 40%, #ffffff 100%'><img class='btn-imagen' src='images/IMG_3987.PNG'/>Exámen Físico</li>";
		...
		echo "<li class='list-group-item mb-2 py-3' style='background-color: #e9effb; background-image: linear-gradient(0deg, #e9effb 0%, #ffffff 40%, #ffffff 100%'><img class='btn-imagen' src='images/IMG_3992.PNG'/>Signos Vitales</li>";
		...
		echo "<li class='list-group-item mb-2 py-3' style='background-color: #e9effb; background-image: linear-gradient(0deg, #e9effb 0%, #ffffff 40%, #ffffff 100%'><img class='btn-imagen' src='images/IMG_3990.PNG'/>Exámenes</li>";		
		...
		echo "<li class='list-group-item mb-2 py-3' style='background-color: #e9effb; background-image: linear-gradient(0deg, #e9effb 0%, #ffffff 40%, #ffffff 100%'><img class='btn-imagen' src='images/IMG_3981.PNG'/>Indicaciones Diarias</li>";			
		...
		echo "<li class='list-group-item mb-2 py-3' style='background-color: #e9effb; background-image: linear-gradient(0deg, #e9effb 0%, #ffffff 40%, #ffffff 100%'><img class='btn-imagen' src='images/IMG_3977.PNG'/>Plan / Comentarios"."</li>";				
