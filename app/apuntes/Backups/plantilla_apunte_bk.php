   		...
   		<li class='list-group-item mb-2'>
   			...
   			<?php
   				...
   				foreach($resultado2 as $clave_result2){
   						echo "<div class='row pt-5'><div class='col text-start'>";
   						echo $clave_result2[0]; //título
   						echo "</div><div class='col input-group'>    	
				      <input class='form-control' type='number' id='$clave_result2[1]' readonly>"; //id
   						echo "<span class='input-group-text' id='basic-addon2'>";	
   						echo $clave_result2[2]; //unidad
   						echo "</span></div></div>	";
	   					}
			      ...
			      function doMath() {
			      	...
			      	<?php
			      		...
			      		foreach($resultado2 as $var_calc2){
			      			echo "var $var_calc2[1]Var = $var_calc2[3]; "; //construye las variables de reslutado y el calculo correspondiente
			      		}

			      		foreach($resultado2 as $var_result2){  //construye los resultados
