...
<footer class="bd-footer py-2 py-md-2 mt-0 bg-secondary text-start" style=' --bs-bg-opacity: 0.1;'>
  <div class="container py-2 py-md-5 px-4 px-md-3" style="font-size: min(max(14px, 1.5vw), 18px)">
    <div class="row">
    <div class="col-lg-3 mb-0">
        <a class="d-inline-flex align-items-center mb-2 link-dark text-decoration-none" href="/" aria-label="Bootstrap">
          <span class='fs-5' style='color:white; filter: invert(.6);'><img class='pe-2' src='../images/austral.png' style='width: 48px' />Anestesia <small class='ps-0 opacity-50' style='font-size: 16px'> UACH</small></span>
        </a>
    ...
    <div class="col-6 col-lg-2 mb-3">
      ...
      <ul class="list-unstyled">
        ...
        <li class="mb-2"><a href="mailto:ddsoto@uach.cl"><i class="fa-solid fa-envelope pe-2"></i>Diseñador Web</a></li>
      </ul>
    </div>
    ...
    <div class="col-6 col-lg-2 mb-3">
      ...
      <ul class="list-unstyled">
        ...
        <li class="mb-2"><a href="https://app.anestesiauach.cl/apuntes.php" target="_self"><i class="fa-solid fa-arrow-right pe-2"></i>Cálculos</a></li>
      </ul>
    </div>
