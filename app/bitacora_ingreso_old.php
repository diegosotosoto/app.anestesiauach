...
// Usar nuevo sistema de seguridad
...
if(isset($_POST['rut_b']) && $_POST['rut_b'] !== ''){
  ...
  $autor_b=strtolower($usuario['email_usuario']);
...
?>
      ...
      <ul class="nav nav-tabs bitacora-tabs">
        <li class="nav-item">
          <a class="nav-link" href="bitacora_ingreso.php">Ingreso (Nuevo)</a>
        </li>
        <li class="nav-item">
          <span class="nav-link active" aria-current="page">Ingreso (Antiguo)</span>
        </li>
        <li class="nav-item">
      ...
      <form class="needs-validation" name="form_ingreso_bit" id="form_ingreso_bit" method="post" action="bitacora_ingreso.php" novalidate>
        ...
        <div class="bitacora-card">
          <div class="bitacora-card-header">
            ...
            <div class='text-black-50 pb-2 pt-1 bitacora-muted-small'><?php echo htmlspecialchars($usuario['email_usuario'], ENT_QUOTES, 'UTF-8'); ?></div>
          </div>
