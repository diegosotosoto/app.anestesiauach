...
<?php 
			//VARIABLES
				$nombre_bd="hipocaloricos_rf";
				$nombre_bd_id="id_hipocaloricos";
				$nombre_bd_plato="nombre_plato_hc";
				$nombre_bd_descripcion="descripcion_plato_hc";
				$nombre_bd_precio="precio_plato_hc";
				$nombre_bd_foto="nombre_foto_hc";
				$nombre_bd_otro="otro_hc";
				$direccion_sitio="gestion_hipocaloricos.php";
				$titulo_pagina="Hipocalóricos";
				$fondo_activo="";
				$acompa_activo="";
				$hipoc_activo="active";
				$postres_activo="";
