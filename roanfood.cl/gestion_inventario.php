...
<?php 
			//VARIABLES
				$nombre_bd="fondo_rf";
				$nombre_bd_id="id_fondo";
				$nombre_bd_plato="nombre_plato_fon";
				$nombre_bd_descripcion="descripcion_plato_fon";
				$nombre_bd_precio="precio_plato_fon";
				$nombre_bd_foto="nombre_foto_fon";
				$nombre_bd_otro="otro_fon";
				$direccion_sitio="gestion_inventario.php";
				$titulo_pagina="Platos de Fondo";
				$fondo_activo="active";
				$acompa_activo="";				
				$hipoc_activo="";
				$postres_activo="";
