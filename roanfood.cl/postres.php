...
<?php 
			//VARIABLES
				$nombre_bd="postres_rf";
				$nombre_bd_id="id_postres";
				$nombre_bd_plato="nombre_plato_pos";
				$nombre_bd_descripcion="descripcion_plato_pos";
				$nombre_bd_precio="precio_plato_pos";
				$nombre_bd_foto="nombre_foto_pos";
				$nombre_bd_otro="otro_pos";
				$direccion_sitio="postres.php";
				$titulo_pagina="Postres";
				$fondo_activo="";
				$acompa_activo="";
				$hipoc_activo="";
				$postres_activo="active";
				$entrada_activo="";
